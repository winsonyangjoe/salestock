    ...
    directions: [
        {
            'Hex': '#7f7f7f',
            'directionName': 'LTR',
            'directionLink': 'http://eazzy.me/html/bella-interiot/'
        },
        {
            'Hex': '#7f7f7f',
            'directionName': 'RTL',
            'directionLink': 'http://eazzy.me/html/bella-interiot-rtl/'
        }
    ],
    initialize: function () {
        var $this = this;
        ...
        $('head').append($('<link rel="stylesheet">').attr('href', 'web_assets/js/theme-config.css'));
        $this.build();
        $this.events();
